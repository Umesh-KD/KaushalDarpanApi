...
{
    public class FlyingSquadDataModel: RequestBaseModel
    {
        public int TeamID { get; set; }
        public int UserID { get; set; }
        public string? TeamName { get; set; }
        public List<FlyingDetailsDataModel>? ObserverDetails { get; set; }
        public string? IPAddress { get; set; }
        public int? DeploymentID { get; set; }
    }

    public class FlyingDetailsDataModel
    {
    ...
    public class FlyingSquadSearchModel: RequestBaseModel
    {
        public int? TeamID { get; set; }
    ...
    public class FlyingSquadDeployModel: RequestBaseModel
    {
        public int DistrictID { get; set; }
        public int InstituteID { get; set; }
        public int ShiftID { get; set; }
    ...
    public class FlyingDeploymentDataModel: RequestBaseModel
    {
        public  int DistrictID { get; set; }
        public  int InstituteID { get; set; }
        public  int ShiftID { get; set; }
    ...
    public class COFlyingDeploymentDataModel: RequestBaseModel
    {
        public List<FlyingDetailsDataModel>? ObserverDetails { get; set; }
        public  int DistrictID { get; set; }
        public  int InstituteID { get; set; }
