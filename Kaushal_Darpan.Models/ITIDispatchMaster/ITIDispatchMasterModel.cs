...
{
    public class ITIDispatchFormDataModel
    {
        ...
        public List<ITIBundelDataModel> BundelDataModel { get; set; } = new List<ITIBundelDataModel>();
        
    }

    public class ITIDispatchSearchModel
    {
        public int DispatchID { get; set; }
        public string? DispatchDate { get; set; }
        public int DepartmentID { get; set; }
    ...
    public class ITIBundelDataModel
    {
        public int BundelID { get; set; }
        public int DispatchID { get; set; }
    ...
    public class ITIDispatchReceivedModel
    {
        public int DispatchID { get; set; }
        public string? DispatchDate { get; set; }
        public int CourseTypeID { get; set; }
    ...
    public class ITIDownloadDispatchReceivedSearchModel
    {
        public int DispatchID { get; set; }
        public string DispatchDate { get; set; }
        public int DepartmentID { get; set; }
    ...
    public class ITIDispatchPrincipalGroupCodeDataModel
    {
        ...
        public List<ITIViewByIDDispatchGroupCodeModel>?  groupCodeModels { get; set; }

    }

    public class ITIDispatchPrincipalGroupCodeSearchModel
    {
        public int DPGCID { get; set; }
        public int DispatchGroupID { get; set; }
        public string DispatchDate { get; set; }
    ...
    public class ITIUpdateStatusDispatchPrincipalGroupCodeModel
    {
        public int DPGCID { get; set; }
        public int DepartmentID { get; set; }
        public int CourseTypeID { get; set; }
    ...
    public class ITIViewByDispatchMasterBundelNo
    {
        public int DispatchID { get; set; }
        public string ExamDate { get; set; }
        public string CenterCode { get; set; }
    ...
    public class ITIUpdateFileHandovertoExaminerByPrincipalModel
    {
        public int DispatchGroupID { get; set; }
    ...
    public class ITICompanyDispatchMasterModel
    {
    ...
    public class ITICompanyDispatchMasterSearchModel
    {
        public int CompanyID { get; set; }
        public int DepartmentID { get; set; }
        public int CourseTypeID { get; set; }
    ...
    public class ITI_Dispatch_ShowbundleSearchModel
    {
        public string Action { get; set; }
