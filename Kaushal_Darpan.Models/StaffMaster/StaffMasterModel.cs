namespace Kaushal_Darpan.Models.StaffMaster
{
    public class StaffMasterModel
    {
        ...
        public List<Staff_EduQualificationDetailsModel> EduQualificationDetailsModel { get; set; }
        public List<StaffSubjectListModel>? StaffSubjectListModel { get; set; }
    ...
    public class Staff_EduQualificationDetailsModel
    {
    ...
    public class AddStaffBasicDetailDataModel:RequestBaseModel
    {
    ...
    public class StaffSubjectListModel
    {
    ...
    public class StaffHostelListModel
    {
