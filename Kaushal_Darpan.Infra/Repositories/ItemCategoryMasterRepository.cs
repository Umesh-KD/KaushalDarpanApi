...
{
    public class ItemCategoryMasterRepository : I_ItemCategoryMasterRepository
    {
        ...
        public ItemCategoryMasterRepository(DBContext dbContext)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandText = "USP_GetAllItemCategory";
        ...
        public async Task<ItemCategoryModel> GetById(int PK_ID)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    if (dataTable != null)
                    {
                        data = CommonFuncationHelper.ConvertDataTable<ItemCategoryModel>(dataTable);
                    }
                    return data;
                }
                catch (Exception ex)
        ...
        public async Task<bool> SaveData(ItemCategoryModel request)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandText = "USP_ItemCategory_IU";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<bool> DeleteDataByID(ItemCategoryModel request)
        {
