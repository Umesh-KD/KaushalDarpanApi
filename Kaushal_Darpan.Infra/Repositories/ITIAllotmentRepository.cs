...
namespace Kaushal_Darpan.Infra.Repositories
{
    ...
    public class ITIAllotmentRepository : IITIAllotmentRepository
    {
        ...
        public async Task<DataTable> GetJailAllData(ITIDirectAllocationSearchModel body)
        {
            _actionName = "GetAllData()";
            try
            {
        ...
        public async Task<DataSet> GetJailStudentDetails(ITIDirectAllocationSearchModel body)
        {
            _actionName = "GetAllDataPhoneVerify()";
            try
            {
        ...
        public async Task<int> UpdateJailAllotments(ITIDirectAllocationDataModel request)
        {
            return await Task.Run(async () =>
            {
                _actionName = "SaveData(GroupMaster request)";
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.Parameters.AddWithValue("@DirectAdmissionType", request.DirectAdmissionType);
                        command.Parameters.AddWithValue("@IPAddress", _IPAddress ?? (object)DBNull.Value);
                        command.Parameters.AddWithValue("@Action", "SaveUpdateJailAllotments");
                        command.Parameters.Add("@Return", SqlDbType.Int);// out
                        command.Parameters["@Return"].Direction = ParameterDirection.Output;// out
        ...
        public async Task<int> RevertJailAllotments(ITIDirectAllocationDataModel request)
        {
            return await Task.Run(async () =>
            {
                _actionName = "RevertAllotments(GroupMaster request)";
        ...
        public async Task<DataTable> GetStudentOptionByApplicationNo(ITIDirectAllocationSearchModel body)
        {
            _actionName = "GetTradeListByCollege()";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GetITIJailAdmissionTrade";
