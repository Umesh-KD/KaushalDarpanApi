...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class ITISeatIntakeMasterRepository : IITISeatIntakeMasterRepository
    {
        ...
        public async Task<int> SaveSeatIntakeDataMaster(BTERSeatIntakeDataModel request)
        {
            _actionName = "SaveSeatIntakeData(SeatIntakeDataModel request)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = await _dbContext.CreateCommandAsync(true))
                    {
                        ...
                        command.CommandText = "USP_ITI_SeatIntakeMaster_IU";
        ...
        public async Task<DataTable> GetAllDataMasterList(BTERSeatIntakeSearchModel request)
        {
            _actionName = "GetAllData(SeatIntakeSearchModel request)";
                ...
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_GetSeatIntakeDataMaster";
                        command.Parameters.AddWithValue("@DistrictID", request.DistrictID);
                        command.Parameters.AddWithValue("@CollegeTypeID", request.CollegeTypeID);
                        command.Parameters.AddWithValue("@CollegeID", request.CollegeID);
                        command.Parameters.AddWithValue("@InstituteCategoryID", request.InstituteCategoryID);
        ...
        public async Task<int> CollegeTradeMasterData(BTERSeatIntakeDataModel request)
        {
            _actionName = "SaveSeatIntakeData(SeatIntakeDataModel request)";
                ...
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_ITI_collegetrademaster_IU";
                        //command.CommandText = "USP_ITI_SeatIntakeSP";
                        ...
                        command.Parameters.AddWithValue("@IntakeStatus", request.IntakeStatus);
        ...
        public async Task<BTERSeatIntakeDataModel> GetByIdPlanning(int id)
        {
            _actionName = "GetById(int PK_ID)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = await _dbContext.CreateCommandAsync())
                    {
                        ...
                        command.CommandText = "USP_ITI_GetSeatIntakeData";
                        command.Parameters.AddWithValue("@SeatIntakeID", id);
                        command.Parameters.AddWithValue("@action", "_getDataByIdplanning");
        ...
        public async Task<DataTable> GetPlanningDashboardData(ITIAdminDashboardSearchModel model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_PlanningDashboard";
