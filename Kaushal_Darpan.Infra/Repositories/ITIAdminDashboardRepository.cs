...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class ITIAdminDashboardRepository : IITIAdminDashboardRepository
    {
        ...
        public async Task<DataTable> GetApprenticeshipDirectorNCVTData(ITIAdminDashboardSearchModel model)
        {
            _actionName = "GetApprenticeshipDirectorNCVTData(ITIAdminDashboardSearchModel model)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITIApprenticeshipDirectorNCVTData";
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                        command.Parameters.AddWithValue("@CourseType", model.Eng_NonEng);
                        command.Parameters.AddWithValue("@UserID", model.UserID);
                        command.Parameters.AddWithValue("@RoleID", model.RoleID);
        ...
        public async Task<DataTable> GetITIEstablishmentDashboard(ITIEstablishmentDashboardSearchModel model)
        {
            _actionName = "GetITIEstablishmentDashboard(ITIEstablishmentDashboardSearchModel model)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_ITI_EM_EstablishmentDashboard";
                    command.Parameters.AddWithValue("@EndTermID", model.EndTermID);
                    command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                    command.Parameters.AddWithValue("@Eng_NonEng", model.Eng_NonEng);
                    command.Parameters.AddWithValue("@InstituteID", model.InstituteID);
        ...
        public async Task<DataTable> GetPostPlanningDashboardTableData(PostPlanningDashboardDataModel model)
        {
            _actionName = "GetPostPlanningDashboardTableData(PostPlanningDashboardDataModel model)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_ITI_EM_PostPlanningDashboardTable";
                    command.Parameters.AddWithValue("@EndTermID", model.EndTermID);
                    command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                    command.Parameters.AddWithValue("@RoleID", model.RoleID);
                    command.Parameters.AddWithValue("@Eng_NonEng", model.Eng_NonEng);
        ...
        public async Task<DataTable> GetPostPlanningDashboardTilesData(PostPlanningDashboardDataModel model)
        {
            ...
            try
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_ITI_EM_PostPlanningDashboardTiles";
                    command.Parameters.AddWithValue("@EndTermID", model.EndTermID);
                    command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                    command.Parameters.AddWithValue("@RoleID", model.RoleID);
                    command.Parameters.AddWithValue("@Eng_NonEng", model.Eng_NonEng);
        ...
        public async Task<DataSet> GetAdmissionDashboardData(ITIAdminDashboardSearchModel model)
        {
            _actionName = "GetAdmissionDashboard()";
            ...
            try
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_ITI_AdmissionDashboardData";
                    command.Parameters.AddWithValue("@ActionName", model.ActionName);
                    command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                    command.Parameters.AddWithValue("@CourseType", model.Eng_NonEng);
                    command.Parameters.AddWithValue("@UserID", model.UserID);
        ...
        public async Task<DataSet> GetAllItidashboard(ITIAdminDashboardSearchModel model)
        {
            _actionName = "GetAdmissionDashboard()";
            ...
            try
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_ITI_GetAlldashboard";
                    command.Parameters.AddWithValue("@ActionName", model.ActionName);
                    command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                    command.Parameters.AddWithValue("@CourseType", model.Eng_NonEng);
                    command.Parameters.AddWithValue("@UserID", model.UserID);
