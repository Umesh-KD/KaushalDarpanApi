...
{
    public class ITIPlacementShortListStudentRepository : I_ITIPlacementShortListStudentRepository
    {
        ...
        public ITIPlacementShortListStudentRepository(DBContext dbContext)
        {
        ...
        public async Task<List<ITIPlacementShortListStudentResponseModel>> GetAllData(ITIPlacementShortlistedStuSearch searchModel)
        {
            _actionName = "GetAllData(ITIPlacementShortListStudentSearchModel searchModel)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandText = "USP_GetITIPlacementShortListStudents";
                    ...
                    var data = new List<ITIPlacementShortListStudentResponseModel>();
                    if (dataTable != null)
                    {
                        data = CommonFuncationHelper.ConvertDataTable<List<ITIPlacementShortListStudentResponseModel>>(dataTable);
                    }
                    return data;
                }
                catch (Exception ex)
        ...
        public async Task<int> SaveAllData(List<ITIPlacementShortListStudentResponseModel> entity)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandText = "USP_ITIAddShortlistData";
                        command.CommandType = CommandType.StoredProcedure;
