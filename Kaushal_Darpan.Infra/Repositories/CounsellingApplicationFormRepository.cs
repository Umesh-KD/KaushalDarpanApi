...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class CounsellingApplicationFormRepository : ICounsellingApplicationFormRepository
    {
        ...
        public async Task<int> SavePersonalDetailsFromAdmin(CounsellingApplicationFormDataModel request)
        {
            _actionName = "SavePersonalDetailsFromAdmin(CounsellingApplicationFormDataModel request)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_Counselling_PersonalDetailsFromAdmin_IU";
                        command.CommandType = CommandType.StoredProcedure;
