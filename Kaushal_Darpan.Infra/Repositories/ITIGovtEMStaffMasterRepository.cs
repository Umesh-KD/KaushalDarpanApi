...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class ITIGovtEMStaffMasterRepository : IITIGovtEMStaffMasterRepository
    {
        ...
        {
            _actionName = "GetITI_Govt_EM_UserProfileStatusHt(ITI_Govt_EM_UserRequestHistoryListSearchDataModel Model)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
        ...
        public async Task<DataTable> GetStaffWorkRegular_ArrangementReort(BTER_EM_GetStaffListDataModel body)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_EM_GetStaffWorkRegular_ArrangementReort";
        ...
        public async Task<DataTable> ITI_EM_DropdownGetData(ITI_EM_DroupdownDataModel model)
        {
            _actionName = "ITI_EM_DropdownGetData(ITI_EM_DroupdownDataModel model)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandTimeout = 0;
                    command.CommandText = "USP_ITI_EM_DropdownGetData";
        ...
        public async Task<DataTable> ITI_OfficeVacancyReport(ITIOfficeVacancyModel model)
        {
            _actionName = "OfficeVacancyModelList(OfficeVacancyModel model)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = await _dbContext.CreateCommandAsync())
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandTimeout = 0;
                        command.CommandText = "USP_ITI_OfficeVacancyReport";
                        command.Parameters.AddWithValue("@Action", "ViewPlanningReport");
                        command.Parameters.AddWithValue("@ID", model.ID);
                        command.Parameters.AddWithValue("@OfficeID", model.OfficeID);
                        command.Parameters.AddWithValue("@InstituteID", model.InstituteID);
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
        ...
        public async Task<DataTable> ITI_EM_GetUserOfficePostDetails(UserOfficePostDataModel model)
        {
            _actionName = "ITI_EM_GetUserOfficePostDetails(UserOfficePostDataModel model)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandTimeout = 0;
                    command.CommandText = "USP_ITI_EM_UserOfficePostDetails_Get";
        ...
        public async Task<DataTable> GetEmployeeServiceDetails_ITI_EM(ITI_Govt_EM_UserRequestHistoryListSearchDataModel Model)
        {
            ...
            try
            {
                ...
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_ITI_Govt_EM_UserProfileStatusHt";
                    command.Parameters.AddWithValue("@Action", "EmployeeServiceHistory");
