...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class PlacementDashboardRepository : IPlacementDashboardRepository
    {
        ...
        public async Task<DataTable> GetIIPDashboardData(PlacementDashboardModel model)
        {
            _actionName = "GetAllData()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_IIPDashboard";
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                        command.Parameters.AddWithValue("@CollegeID", model.CollegeID);
                        command.Parameters.AddWithValue("@UserId", model.UserId);
                        command.Parameters.AddWithValue("@RoleID", model.RoleID);
        ...
        public async Task<DataTable> GetIIPDashboardListData(PlacementDashboardModel model)
        {
            _actionName = "GetAllData()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_IIPDashboardListData";
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                        command.Parameters.AddWithValue("@CollegeID", model.CollegeID);
                        command.Parameters.AddWithValue("@UserId", model.UserId);
                        command.Parameters.AddWithValue("@RoleID", model.RoleID);
