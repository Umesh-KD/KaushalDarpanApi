...
namespace Kaushal_Darpan.Infra.Repositories
{
...

    {
        ...
        public async Task<DataTable> HODSemesterMaster(int UserID = 0, int StreamType = 0, int EndTermId = 0)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_DDL_HODSemesterMaster";
                        command.Parameters.AddWithValue("@UserID", UserID);
                        command.Parameters.AddWithValue("@EndTermId", EndTermId);
                        command.Parameters.AddWithValue("@StreamType", StreamType);
        ...
        public async Task<DataTable> SemesterList(int DepartmentID = 0)
        {
            _actionName = "StreamMaster()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_DDL_SemesterList";
                        command.Parameters.AddWithValue("@DepartmentID", DepartmentID);
                        //command.Parameters.AddWithValue("@EndTermId", EndTermId);
                        //command.Parameters.AddWithValue("@StreamType", StreamType);
                        //command.Parameters.AddWithValue("@SemesterID", SemesterID);
        ...
        public async Task<DataTable> CenterCodeMaster()
        {
            _actionName = "CenterCodeMaster";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_DDL_CenterCodeMaster";
        ...
        public async Task<List<CommonDDLModel>> GetAssignedSubject(string SSOID, int EndTermID, int SemesterID, int Eng_NonEng, int StreamID)
        {
            _actionName = "SubjectMaster_StreamIDWise(int StreamID)";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GetAssignedsubject";
                        command.Parameters.AddWithValue("@StreamID", StreamID);
                        command.Parameters.AddWithValue("@SSOID", SSOID);
                        command.Parameters.AddWithValue("@SemesterID", SemesterID);
                        command.Parameters.AddWithValue("@Eng_NonEng", Eng_NonEng);
        ...
        public async Task<DataTable> QualificationDetailsDDL(QualificationDDLDataModel request)
        {
            _actionName = "StreamDDL_InstituteWise(QualificationDDLDataModel request)";
            return await Task.Run(async () =>
            {
        ...
        public async Task<DataTable> Get_Staff_Ac_Year(StaffMasterDDLDataModel body)
        {
            _actionName = "GetAllData()";
            try
            {
        ...
        protected async Task SetIdentityOffOn(string table, string OffOn)
        {
        ...
        public async Task<DataTable> GetStaff_InstituteAndWorkWise(StaffMasterDDLDataModel body)
        {
            _actionName = "GetAllData()";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_BTER_Get_Staff_InstituteWorkWise";
                        command.Parameters.AddWithValue("@InstituteID", body.InstituteID);
                        command.Parameters.AddWithValue("@WorkInstituteID", body.WorkInstituteID);
                        command.Parameters.AddWithValue("@Eng_NonEng", body.Eng_NonEng);
                        command.Parameters.AddWithValue("@DepartmentID", body.DepartmentID);
                        command.Parameters.AddWithValue("@RoleID", body.RoleID);
                        _sqlQuery = command.GetSqlExecutableQuery();// Get sql query
        ...
        public async Task<DataTable> GetStaff_InstituteAcRoster(StaffMasterDDLDataModel body)
        {
            _actionName = "GetStaff_InstituteAcRoster()";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_BTER_GetStaff_InstituteAcRoster";
                        command.Parameters.AddWithValue("@InstituteID", body.InstituteID);
        ...
        public async Task<DataTable> THTE_StatusDDL(THTE_DropdownDataModel model)
        {
            _actionName = "THTE_StatusDDL(DropdownDataModel model)";
            return await Task.Run(async () =>
            {
                try
                {
        ...
        public async Task<List<CommonDDLModel>> DDL_ITI_GovtEMDDLOfficeVacancy(int DepartmentID, int LevelID)
        {
            _actionName = "DDL_ITI_GovtEMDDLOfficeVacancy()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_GovtEMDDLOfficeVacancy";
                        command.Parameters.AddWithValue("@DepartmentID", DepartmentID);
                        command.Parameters.AddWithValue("@LevelID", LevelID);
                        _sqlQuery = command.GetSqlExecutableQuery();
                        dataTable = await command.FillAsync_DataTable();
        ...
        public async Task<DataTable> GetDDLCounselling_Qualification()
        {
            _actionName = "GetDDLCounselling_Qualification()";
            return await Task.Run(async () =>
            {
                try
                {
        ...
        public async Task<DataTable> DDL_AllCasteCategoryA()
        {
            _actionName = "DDL_AllCasteCategoryA()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_DDL_AllCasteCategoryA";
        ...
        public async Task<DataTable> DDL_Counselling_Trade(int designationId)
        {
            _actionName = "DDL_Counselling_Trade()";
            return await Task.Run(async () =>
            {
                try
                {
        ...
        public async Task<DataTable> GetDocumentDetails_RejectAtBter(GetDocumentDetails_RejectAtBter_DataModel model)
        {
            _actionName = "GetDocumentDetails_RejectAtBter(GetDocumentDetails_RejectAtBter_DataModel model)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GetDocumentDetails_ForReject";
                        command.Parameters.AddWithValue("@action", "getDocument_RejectAtBter");
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                        command.Parameters.AddWithValue("@FileNameWithDynamicPath", model.FileNameWithDynamicPath);
        ...
        public async Task<DataTable> GetZonalID(int UserID, int EndTermID)
        {
            _actionName = "GetAllData()";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GetZonalID";
                        command.Parameters.AddWithValue("@UserID", UserID);
                        command.Parameters.AddWithValue("@EndTermID", EndTermID);
                        _sqlQuery = command.GetSqlExecutableQuery();// Get sql query
                        dataTable = await command.FillAsync_DataTable();
        ...
        {
            _actionName = "GetCommonMasterDDLByAction(string type)";
            return await Task.Run(async () =>
            {
                try
                {
        ...
        public async Task<DataTable> GetStudentDeatilsByActionITI(StudentSearchModelForWhatsAPP filterModel)
        {
            _actionName = "GetStudentDeatilsByAction()";
            string Action = "PendingFees";
            return await Task.Run(async () =>
