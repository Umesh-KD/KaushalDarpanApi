...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class ReportRepository : IReportRepository
    {
        ...
        public async Task<DataTable> GetAllDataRpt(TheorySearchModel body)
        {
            ...
            try
            {
                ...
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    ...
                    else if (body.StrKey == "totl1")
                    {
                        command.CommandText = "USP_GetInternalMarkingStudentRPT";
                        command.Parameters.AddWithValue("@Action", "_getInternalPracticalStudentTotal");
                    }
                    else if (body.StrKey == "totl2")
                    {
                        command.CommandText = "USP_GetInternalMarkingStudentRPT";
                        command.Parameters.AddWithValue("@Action", "_getInternalAssismentStudentTotal");
                    }
                    else if (body.StrKey == "mrkent1")
                    {
                        command.CommandText = "USP_GetInternalMarkingStudentRPT";
                        command.Parameters.AddWithValue("@Action", "_getInternalPracticalStudentMarksEntered");
                    }
                    else if (body.StrKey == "mrkent2")
                    {
                        command.CommandText = "USP_GetInternalMarkingStudentRPT";
                        command.Parameters.AddWithValue("@Action", "_getInternalAssismentStudentMarksEntered");
                    }
                    else
                    {
        ...
        {
            _actionName = "GetExamLetterReport(ExamLetterReport model)";
            try
            {
                var ds = new DataSet();
                using (var command = await _dbContext.CreateCommandAsync())
        ...
        {
            _actionName = "ScaReportAdmin(StudentCenteredActivitesMasterSearchModel body)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    ...
                    if (body.StrKey == "totl3")
                    {
                        command.CommandText = "USP_GetInternalMarkingStudentRPT";
                        command.Parameters.AddWithValue("@Action", "_getSCAStudentTotal");
                    }
                    else if (body.StrKey == "mrkent3")
                    {
                        command.CommandText = "USP_GetInternalMarkingStudentRPT";
                        command.Parameters.AddWithValue("@Action", "_getSCAStudentMarksEntered");
                    }
                    else
                    {
        ...
        public async Task<DataSet> UFM_Collegwise_CategoryReportPdf_BTER(UFMCategoryUpdateModel body)
        {
            _actionName = "UFM_Collegwise_CategoryReportPdf_BTER(TheorySearchModel body)";
            try
            {
                var ds = new DataSet();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    ...
                    command.Parameters.AddWithValue("@action", "_getCollegwise_UFMCategoryStudentData");
                    //command.Parameters.AddWithValue("@StudentID", body.StudentID);
                    command.Parameters.AddWithValue("@EndTermID", body.EndTermID);
                    command.Parameters.AddWithValue("@FinancialYearID", body.FinancialYearID);
                    command.Parameters.AddWithValue("@Eng_NonEng", body.Eng_NonEng);
        ...
        public async Task<DataSet> downloadResultAppearedPassedStatisticsReport(ResultAppearedPassedStatisticsReportModel model)
        {
            _actionName = "downloadResultAppearedPassedStatisticsReport(ResultAppearedPassedStatisticsReportModel model)";
            try
            {
                DataSet ds = new DataSet();
                using (var command = await _dbContext.CreateCommandAsync())
        ...
        public async Task<DataSet> GetRevalExamLetterReport(ExamLetterReport model)
        {
            _actionName = "GetRevalExamLetterReport(ExamLetterReport model)";
            try
            {
                var ds = new DataSet();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_GetRevalGroupCode_brachwisewise_Report";
        ...
        public async Task<DataSet> GetRevalGroupCodeMasterReportBranchwise(GroupCodeAllocationAddEditModel_Reval filterModel)
        {
            ...
            try
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_GetRevalGroupCodeMasterReport_brachwise";
                    //command.CommandText = "USP_GetGroupCodeMasterReport_dummy";
        ...
        public async Task<DataSet> GetRevalGroupCodeMasterReport(GroupCodeAllocationAddEditModel_Reval filterModel)
        {
            ...
            try
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_GetRevalGroupCodeMasterReport";
                    //command.CommandText = "USP_GetGroupCodeMasterReport_dummy";
        ...
        public async Task<DataTable> GetProvesionalMeritList(GetProvesionalMeritModel model)
        {
            _actionName = "GetProvesionalMeritList(GetProvesionalMeritModel model)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
