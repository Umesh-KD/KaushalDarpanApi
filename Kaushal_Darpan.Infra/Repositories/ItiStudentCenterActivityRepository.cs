...
{
    public class ItiStudentCenterActivityRepository : IItiStudentCenterActivityRepository
    {
        ...
        public ItiStudentCenterActivityRepository(DBContext dbContext)
        {
        ...
        public async Task<DataTable> GetAllData(ITIStudentCenterActiviteSearchModel body)
        {
        ...
        public async Task<int> UpdateSaveData(List<ITIStudentCenterActivities> entity)
        {
