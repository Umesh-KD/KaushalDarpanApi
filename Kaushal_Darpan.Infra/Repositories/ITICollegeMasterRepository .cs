...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class ITICollegeMasterRepository : IITICollegeMasterRepository
    {
        ...
        public async Task<DataTable> ITISearchCollegeTrade(ItiSearchCollegeModel model)
        {
            _actionName = "PolotechnicSearchCollege()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_OptionFormOptionpublic";
                        command.Parameters.AddWithValue("@Action", model.Action);
                        command.Parameters.AddWithValue("@DivisionID", model.DivisionID);
                        command.Parameters.AddWithValue("@DistrictID", model.DistrictID);
                        command.Parameters.AddWithValue("@CollegeID", model.InstituteID);
                        command.Parameters.AddWithValue("@TradeID", model.TradeID);
        ...
        public async Task<DataTable> ITIReportedStudentGetByID(int ApplicationID)
        {
            _actionName = "ITIReportedStudentGetByID(int ApplicationID)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_Get_ITIReportedStudent_ById";
