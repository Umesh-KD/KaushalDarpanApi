...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class StudentRepository : IStudentRepository
    {
        ...
        public async Task<DataTable> GetStudentAttendanceReport(AttendanceTimeTableModal model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_BTER_Get_StudentAttandanceReport";
        ...
        public async Task<DataTable> GetStudentAttendance_ITIReport(AttendanceTimeTableModal model)
        {
            _actionName = "GetStudentAttendance()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_Get_StudentAttandanceReport";
        ...
        public async Task<DataTable> GetTeacherAttendence(AttendanceTimeTableModal model)
        {
            _actionName = "GetTeacherAttendence()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_Get_TeacherAttendanceReport";
        ...
        public async Task<DataTable> GetStudentAttendanceSubjectwise(AttendanceTimeTableModal model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_Rpt_Student_Attendance";
        ...
        public async Task<int> SetCalendarEventModelITI(List<CalendarEventModel> model)
        {
            _actionName = "SetCalendarEventModel(List<CalendarEventModel> model)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = await _dbContext.CreateCommandAsync(true))
                    {
                        ...
                        command.CommandText = "USP_GetEventsITI";
        ...
        public async Task<int> UpdateCalendarEventModelBter(List<CalendarEventModelITI> model)
        {
            _actionName = "SetCalendarEventModel(List<CalendarEventModel> model)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = await _dbContext.CreateCommandAsync(true))
                    {
                        ...
                        command.CommandText = "USP_UpdateStudentAttendanceLockUnlock";
        ...
        public async Task<DataTable> getCalendarEventModelITI(CalendarEventModel model)
        {
            _actionName = "ITIGetDataStudentBySSOId()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GetEventsListITI";
        ...
        public async Task<DataTable> getAssignCalendarEventModelBter(CalendarEventModelITI model)
        {
            _actionName = "getAssignCalendarEventModelBter()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_BTER_GetAttendanceEventList";
                        ...
                        command.Parameters.AddWithValue("@StaffID", model.StaffID);
                        command.Parameters.AddWithValue("@EndTermID", model.EndTermID);
                        command.Parameters.AddWithValue("@TimeDDLID", model.TimeID);
                        _sqlQuery = command.GetSqlExecutableQuery();
                        dataTable = await command.FillAsync_DataTable();
                    }
        ...
        public async Task<DataTable> GetReAssignTeacher(ReAssignTeacherDataModel body)
        {
            _actionName = "USP_ReAssignTeacherList()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ReAssignTeacherList";
        ...
        public async Task<int> ReAssignTeacherForSaveLC(ReAssignTeacherSaveModel model)
        {
            _actionName = "AddStudentAttendance()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_ReAssignTeacherLC_Save";
                        command.CommandType = CommandType.StoredProcedure;
                        command.Parameters.AddWithValue("@SSOID", model.SSOID);
                        command.Parameters.AddWithValue("@SSOIDBY", model.SSOIDBY);
                        command.Parameters.AddWithValue("@StaffID", model.StaffID);
                        command.Parameters.AddWithValue("@From_Date", model.From_Date);
                        command.Parameters.AddWithValue("@To_Date", model.To_Date);
                        command.Parameters.AddWithValue("@InstituteID", model.InstituteID);
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                        command.Parameters.AddWithValue("@AssignTeacherForSubjectID", model.AssignTeacherForSubjectID);
                        command.Parameters.AddWithValue("@rdID", model.rdID);
                        command.Parameters.Add("@Return", SqlDbType.Int); // out
                        command.Parameters["@Return"].Direction = ParameterDirection.Output; // out
                        _sqlQuery = command.GetSqlExecutableQuery();
                        result = await command.ExecuteNonQueryAsync();
        ...
        public async Task<DataTable> GetStudentAttendanceTLC(AttendanceTimeTableTLCModal model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_BTER_Get_StudentAttandanceTLC";
        ...
        public async Task<int> SaveStudentAttendanceTLC(List<PostAttendanceTimeTableTLCModal> model)
        {
            _actionName = "SaveStudentAttendanceTLC()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_Save_StudentAttandanceTLC";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<DataTable> GetReAttendanceTimeTable(AttendanceTimeTableModal model)
        {
            _actionName = "GetDataStudentBySSOId()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_BTER_ReAssignTeacherForSubject";
