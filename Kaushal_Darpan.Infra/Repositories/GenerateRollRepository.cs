...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class GenerateRollRepository : IGenerateRollRepository
    {
        ...
        public async Task<DataTable> GetCenterAdmit_RollListPdf(GenerateRollSearchModel model)
        {
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_CenterAdmit_RollListPdfDetails";
                        command.Parameters.AddWithValue("@Action", model.Action);
                        command.Parameters.AddWithValue("@EndTermID", model.EndTermID);
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                        command.Parameters.AddWithValue("@PDFType", model.PDFType);
        ...
        public async Task<DataTable> GetCenterAdmit_RollListPdf_New(GenerateRollSearchModel model)
        {
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_CenterAdmit_RollListPdfDetails_new";
                        command.Parameters.AddWithValue("@Action", model.Action);
                        command.Parameters.AddWithValue("@EndTermID", model.EndTermID);
                        command.Parameters.AddWithValue("@DepartmentID", model.DepartmentID);
                        command.Parameters.AddWithValue("@PDFType", model.PDFType);
