...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class ItiTheoryMarksRepository : IItiTheoryMarksRepository
    {
        ...
        public async Task<int> UnlockBundle1(RevertBundleModel entity)
        {
            _actionName = "UpdateSaveData(List<ITITheoryMarksModel> entity)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_ITI_unlockexaminerbundle";
                        command.CommandType = CommandType.StoredProcedure;
                        ...
                        command.Parameters.AddWithValue("@Remark", entity.Remark);
                        command.Parameters.AddWithValue("@FinalSubmit", entity.FinalSubmit);
                        command.Parameters.AddWithValue("@CenterID", entity.CenterID);
                        command.Parameters.AddWithValue("@SemesterID", entity.SemesterID);
                        command.Parameters.AddWithValue("@StreamID", entity.StreamID);
                        command.Parameters.AddWithValue("@SubjectName", entity.SubjectName);
        ...
        public async Task<DataTable> GetTraineeStudent(TheorySearchModel body)
        {
            _actionName = "GetTraineeStudent(TheorySearchModel body)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_Rpt_GetITIStudentPaperLiST";
