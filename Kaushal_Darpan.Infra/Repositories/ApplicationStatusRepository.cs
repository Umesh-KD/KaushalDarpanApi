...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class ApplicationStatusRepository : IApplicationStatusRepository
    {
        ...
        public async Task<DataTable> EditQualificationList(StudentSearchModel searchModel)
        {
            _actionName = "StudentJailAdmission(StudentSearchModel searchModel)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GeTEditqualList";
        ...
        public async Task<DataTable> AddQualificationDetails(StudentSearchModel searchModel)
        {
            _actionName = "StudentJailAdmission(StudentSearchModel searchModel)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GeTAddqualList";
