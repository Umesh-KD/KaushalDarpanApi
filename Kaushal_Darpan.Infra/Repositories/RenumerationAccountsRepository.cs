...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class RenumerationAccountsRepository : IRenumerationAccounts
    {
        ...
        #region reval
        public async Task<List<RenumerationAccountsModel>> GetAllData_Reval(RenumerationAccountsRequestModel filterModel)
        {
            _actionName = "GetAllData_Reval(RenumerationExaminerRequestModel filterModel)";
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_RenumerationAccounts_Reval";
        ...
        public async Task<int> SaveDataApprovedFromAccounts_Reval(RenumerationAccountsSaveModel request)
        {
            _actionName = "SaveDataApprovedFromAccounts_Reval(RenumerationAccountsSaveModel request)";
                try
                {
                    int result = 0;
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "usp_SaveRenumerationAccounts_Reval";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<int> HasDblicateTvNoAndVoucharNo_Reval(RenumerationAccountsSaveModel request)
        {
            _actionName = "HasDblicateTvNoAndVoucharNo_Reval(RenumerationAccountsSaveModel request)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = await _dbContext.CreateCommandAsync(true))
                    {
                        command.CommandText = "usp_CheckDublicateRenumeration_Reval";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<int> UpdateDataApprovedFromAccounts_Reval(RenumerationAccountsSaveModel request)
        {
            _actionName = "UpdateDataApprovedFromAccounts_Reval(RenumerationAccountsSaveModel request)";
            return await Task.Run(async () =>
            {
                try
                {
