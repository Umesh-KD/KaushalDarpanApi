...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class DTEItemsMasterRepository : IDTEItemsMasterRepository
    {
        ...
        {
            _actionName = "SaveIssueItems(ItemsIssueReturnModels request)";
            try
            {
                int result = 0;
                using (var command = await _dbContext.CreateCommandAsync())
        ...
        {
            _actionName = " GetInventoryIssueItemList(inventoryIssueHistorySearchModel SearchReq)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
        ...
        {
            _actionName = "GetIssueItemList(ItemsIssueReturnModels SearchReq)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
        ...
        public async Task<DataTable> GetDTEIssueItemListPermanent(int EquipmentsId, int ItemCategoryId, int InstituteID, int UserID, int OfficeID)
        {
            _actionName = "GetDTEIssueItemListPermanent(int EquipmentsId, int ItemCategoryId,int InstituteID)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
        ...
        {
            _actionName = "GetDTEIssueSubmitPermanent(ItemsIssueReturnModels SearchReq)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync(true))
        ...
        {
            _actionName = "GetDTEGetSetLabMaster(DTELabMasterModel SearchReq)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync(true))
        ...
        {
            _actionName = "DTE_INV_SaveLabItemReturn(ItemsIssueReturnModels SearchReq)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync(true))
        ...
        {
            _actionName = "MarkForAuctionSR6(List<ItemsIssueReturnModels> request)";
            try
            {
                int result = 0;
                using (var command = await _dbContext.CreateCommandAsync(true))
        ...
        public async Task<DataTable> GetAllNotWorkingItemReport(NotWorkingItemReportSearchModel SearchReq)
        {
            _actionName = "GetAllNotWorkingItemReport(NotWorkingItemReportSearchModel SearchReq)";
            try
            {
                DataTable dataTable = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_Bter_GetAllNotWorkingItemReport";
                    command.Parameters.AddWithValue("@StaffID", SearchReq.StaffID);
                    command.Parameters.AddWithValue("@InstituteID", SearchReq.InstituteID);
                    command.Parameters.AddWithValue("@ItemID", SearchReq.ItemID);
                    command.Parameters.AddWithValue("@UserID", SearchReq.UserID);
        ...
        public async Task<DataTable> GetInventoryAllIssueItemList(inventoryIssueHistorySearchModel SearchReq)
        {
            _actionName = "GetAllInventoryIssueReturnItemList(inventoryIssueHistorySearchModel SearchReq)";
            try
            {
