...
{
    public class ITIViewPlacedStudentsRepository : I_ITIViewPlacedStudentsRepository
    {
        ...
        public ITIViewPlacedStudentsRepository(DBContext dbContext)
        {
            _dbContext = dbContext;
            _pageName = "ITIViewPlacedStudentsRepository";
            _IPAddress = CommonFuncationHelper.GetIpAddress();
        }

        public async Task<DataTable> GetAllData(ITIViewPlacedStudents body)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandText = "USP_ITIViewPlacedStudent";
