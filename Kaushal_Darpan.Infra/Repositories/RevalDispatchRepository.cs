...
{
    public class RevalDispatchRepository : IRevalDispatchRepository
    {
        ...
        public RevalDispatchRepository(DBContext dbContext)
        {
            _dbContext = dbContext;
            _pageName = "RevalDispatchRepository";
        ...
        public async Task<DataTable> GetRevalDispatchInstituteWiseExaminerBundle(DispatchGroupSearchModel SearchReq)
        {
            _actionName = "GetRevalDispatchInstituteWiseExaminerBundle(DispatchGroupSearchModel SearchReq)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDispatchInstituteWiseExaminerBundle";
                        command.Parameters.AddWithValue("@InstituteID", SearchReq.InstituteID);
                        command.Parameters.AddWithValue("@DepartmentID", SearchReq.DepartmentID);
                        command.Parameters.AddWithValue("@EndTermID", SearchReq.EndTermID);
                        command.Parameters.AddWithValue("@CourseTypeID", SearchReq.CourseTypeID);
        ...
        public async Task<int> SaveRevalDispatchInstituteWiseExaminerBundle(RevalDispatchGroupModel request)
        {
            _actionName = "SaveRevalDispatchInstituteWiseExaminerBundle(RevalDispatchGroupModel request)";
            return await Task.Run(async () =>
            {
                var jsonData = JsonConvert.SerializeObject(request.GroupDataModel);
                ...
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandText = "USP_B_RevalDispatchGroup_IU";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<DataTable> GetB_RevalAllGroupData(DispatchSearchModel SearchReq)
        {
            _actionName = "GetAllGroupData()";
            return await Task.Run(async () =>
            {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_RevalDispatchStatusUpdate_IU";
        ...
        public async Task<RevalDispatchGroupModel> GetRevalGroupdetailsId(int PK_Id)
        {
            _actionName = "GetById(int PK_ID)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_RevalDispatchGroupById";
                        command.Parameters.AddWithValue("@PK_Id", PK_Id);

                        _sqlQuery = command.GetSqlExecutableQuery();// Get sql query
                        dataSet = await command.FillAsync();
                    }
                    var data = new RevalDispatchGroupModel();
                    if (dataSet != null)
                    {
                        if (dataSet.Tables.Count > 0)
                        {
                            data = CommonFuncationHelper.ConvertDataTable<RevalDispatchGroupModel>(dataSet.Tables[0]);

                            if (dataSet.Tables[1].Rows.Count>0)
                            {

                                data.GroupDataModel = CommonFuncationHelper.ConvertDataTable<List<RevalDispatchGroupCodeModel>>(dataSet.Tables[1]);
        ...
        public async Task<int> RevalDeleteGroupById(RevalDispatchGroupModel body)
        {
            _actionName = "RevalDeleteGroupById(RevalDispatchGroupModel body)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_RevalDeleteDispatchGroupbyId";
                        command.Parameters.AddWithValue("@ID", body.DispatchGroupID);
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDispatchGroupPrinciple";
                        //command.Parameters.AddWithValue("@DispatchID", SearchReq.DispatchID);
                        //command.Parameters.AddWithValue("@DispatchDate", SearchReq.DispatchDate);
                        command.Parameters.AddWithValue("@DepartmentID", SearchReq.DepartmentID);
                        command.Parameters.AddWithValue("@CourseTypeID", SearchReq.CourseTypeID);
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDispatchUpdateBundleHandovertoExaminerByPrincipal";
        ...
        public async Task<DataTable> GetRevalDispatchGroupcodeDetailsCheck(DispatchPrincipalGroupCodeSearchModel SearchReq)
        {
            _actionName = "GetRevalDispatchGroupcodeDetailsCheck(DispatchPrincipalGroupCodeSearchModel SearchReq)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GetRevalDispatchGroupcodeDetailsCheck";
        ...
        public async Task<int> SaveRevalDispatchPrincipalGroupCodeData(DispatchPrincipalGroupCodeDataModel request)
        {
            _actionName = " SaveRevalDispatchPrincipalGroupCodeData(DispatchPrincipalGroupCodeDataModel request)";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandText = "USP_B_RevalDispatchPrincipalGroupCode_IU";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<DataTable> GetRevalDispatchGroupcodeList(DispatchPrincipalGroupCodeSearchModel SearchReq)
        {
            _actionName = "GetRevalDispatchGroupcodeList(DispatchPrincipalGroupCodeSearchModel SearchReq)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_M_RevalDispatchPrincipalGroupCode";
                        command.Parameters.AddWithValue("@DPGCID", SearchReq.DPGCID);
                        command.Parameters.AddWithValue("@CourseTypeID", SearchReq.CourseTypeID);
                        command.Parameters.AddWithValue("@EndTermID", SearchReq.EndTermID);
                        command.Parameters.AddWithValue("@InstituteID", SearchReq.InstituteID);
        ...
        public async Task<DispatchPrincipalGroupCodeDataModel> GetRevalDispatchGroupcodeId(int PK_Id)
        {
            _actionName = "GetRevalDispatchGroupcodeId(int PK_Id)";
            try
            {
                return await Task.Run(async () =>
                {
        ...
        public async Task<int> RevalDeleteDispatchPrincipalGroupCode(RevalDeleteDispatchPrincipalGroupCodeCModel body)
        {
            _actionName = "RevalDeleteDispatchPrincipalGroupCode(RevalDeleteDispatchPrincipalGroupCodeCModel body)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_RevalDeleteDispatchPrincipalGroupCode";
        ...
        public async Task<DataTable> getRevalgroupExaminerData(DispatchSearchModel SearchReq)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_RevalDispatchGroupExaminer";
                        //command.Parameters.AddWithValue("@DispatchID", SearchReq.DispatchID);
                        //command.Parameters.AddWithValue("@DispatchDate", SearchReq.DispatchDate);
                        command.Parameters.AddWithValue("@DepartmentID", SearchReq.DepartmentID);
                        command.Parameters.AddWithValue("@CourseTypeID", SearchReq.CourseTypeID);
        ...
        public async Task<int> OnRevalSTatusUpdateByExaminer(List<DispatchStatusUpdate> model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDispatchStatusUpdateByExaminer_IU";
        ...
        public async Task<int> RevalBundelNoSendToThePrincipalByTheExaminer(List<DispatchStatusUpdate> model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDispatchBundelNoSendToThePrincipalByTheExaminer";
        ...
        public async Task<int> OnVerifiedtoPrincipalToAdmin(List<DispatchStatusUpdate> model)
        {
            _actionName = "OnVerifiedtoPrincipalToAdmin(List<DispatchStatusUpdate> model)";
            return await Task.Run(async () =>
            {
                try
                {
        ...
        public async Task<DataSet> RevalDownloadAckReportPri(DispatchSearchModel SearchReq)
        {
            _actionName = "getgroupteacherData()";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDispatchGroupPrinciple_Rpt";
                        //command.Parameters.AddWithValue("@DispatchID", SearchReq.DispatchID);
                        //command.Parameters.AddWithValue("@DispatchDate", SearchReq.DispatchDate);
                        command.Parameters.AddWithValue("@DepartmentID", SearchReq.DepartmentID);
                        command.Parameters.AddWithValue("@CourseTypeID", SearchReq.CourseTypeID);
        ...
        public async Task<DataTable> GetRevalDownloadDispatchReceived(DownloadDispatchReceivedSearchModel SearchReq, string DownloadFile, string Dis_DownloadFile)
        {
            _actionName = "GetRevalDownloadDispatchReceived(DownloadDispatchReceivedSearchModel SearchReq)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDownloadDispatchReceived";
                        command.Parameters.AddWithValue("@DispatchID", SearchReq.DispatchID);
                        command.Parameters.AddWithValue("@Dis_DownloadFile", Dis_DownloadFile);
                        command.Parameters.AddWithValue("@DownloadFile", DownloadFile);
                        command.Parameters.AddWithValue("@Action", SearchReq.Action);
            ...
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand())
                    {
                        ...
                        command.CommandText = "USP_B_RevalDispatchUpdate_Remark_Image_HandedOverToExaminerByPrincipal";
                        command.CommandType = CommandType.StoredProcedure;
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_B_RevalDispatchPrincipalGroupCodeStatusUpdate_IU";
