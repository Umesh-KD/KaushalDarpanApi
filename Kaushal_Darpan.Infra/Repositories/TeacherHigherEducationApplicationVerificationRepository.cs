...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class TeacherHigherEducationApplicationVerificationRepository : ITeacherHigherEducationApplicationVerificationRepository
    {
        ...
        public async Task<DataTable> ApplicationList_ForCommitteeAfterPrinciple_THTE(PrincipleApplicationListSearchModel model)
        {
            _actionName = "ApplicationList_ForPrinciple_THTE(PrincipleApplicationListSearchModel model)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_THTE_ApplicationList_ForCommitteeAfterPrinciple";
        ...
        public async Task<int> UpdateApplicationStatus_CommitteeAfterPrinciple_THTE(List<UpdateApplicationStatusDataModel_Principle> model)
        {
            _actionName = "UpdateApplicationStatus_Principle_THTE(List<UpdateApplicationStatusDataModel_Principle> model)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_THTE_UpdateApplicationStatus_CommitteeAfterPrinciple";
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandTimeout = 0;
        ...
        public async Task<int> DTECommitteeAssign_THTE(List<UpdateApplicationStatusDataModel_Principle> model)
        {
            _actionName = "DTECommitteeAssign_THTE(List<UpdateApplicationStatusDataModel_Principle> model)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_THTE_DTECommitteeAssign";
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandTimeout = 0;
        ...
        public async Task<DataTable> StaffDetailsPreview_THTE(StaffDetailsPreviewDataModel model)
        {
            _actionName = "StaffDetailsPreview_THTE(StaffDetailsPreviewDataModel model)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_THTE_GetStaffDetailsPreview";
