...
{
    public class ITIFlyingSquadManageRepository : I_ITIFlyingSquadManageRepository
    {
        ...
        public ITIFlyingSquadManageRepository(DBContext dbContext)
        {
            _dbContext = dbContext;
            _pageName = "ITIFlyingSquadManageRepository";
            _IPAddress = CommonFuncationHelper.GetIpAddress();
        }

        public async Task<int> SaveData(ITIFlyingSquadDataModel request)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandText = "USP_ITI_FlyingSquad_IU";
        ...
        public async Task<DataTable> GetAllData(ITIFlyingSquadSearchModel body)
        {
            ...
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_FlyingSquad";
        ...
        public async Task<DataTable> GetAllInspectedData(ITIFlyingSquadSearchModel body)
        {
            _actionName = "GetAllData()";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_FlyingSquadReport";
                        command.Parameters.AddWithValue("@Action", "GetAllData");
                        command.Parameters.AddWithValue("@EndTermID", body.EndTermID);
                        command.Parameters.AddWithValue("@Eng_NonEng", body.Eng_NonEng);
                        command.Parameters.AddWithValue("@DepartmentID", body.DepartmentID);
        ...
        public async Task<ITIFlyingSquadDataModel> GetById(int ID, int DepartmentID)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    var data = new ITIFlyingSquadDataModel();
                    if (dataSet != null)
                    {
                        if (dataSet.Tables.Count > 0)
                        {
                            data = CommonFuncationHelper.ConvertDataTable<ITIFlyingSquadDataModel>(dataSet.Tables[0]);
                            if (dataSet.Tables[1].Rows.Count > 0)
                            {
                                data.ObserverDetails = CommonFuncationHelper.ConvertDataTable<List<ITIFlyingDetailsDataModel>>(dataSet.Tables[1]);
                            }
                        }
                    }
                    return data;
        ...
        public async Task<bool> DeleteDataByID(ITIFlyingSquadDataModel model)
        {
            _actionName = "GetById(int PK_ID)";
            return await Task.Run(async () =>
            {
        ...
        public async Task<int> SaveDeploymentData(List<ITIFlyingDeploymentDataModel> request)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_ITI_FlyingSquadDeployment_IU";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<DataTable> GetObserverDataByID_Status(ITIFlyingSquadSearchModel body)
        {
            _actionName = "GetAllData()";
            try
            {
        ...
        public async Task<DataTable> GetDeploymentDetailsByID(ITIFlyingSquadSearchModel body)
        {
            _actionName = "GetAllData()";
            try
            {
        ...
        public async Task<DataTable> GetAllDataForVerify(ITIFlyingSquadSearchModel body)
        {
            _actionName = "GetAllData()";
            try
            {
        ...
        public async Task<int> SaveDeploymentVerifiedData(List<ITICOFlyinDeploymentDataModel> request)
        {
            _actionName = "SaveData(SetExamAttendanceModel request)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_ITI_FlyingSquadDeployment_Verify";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<DataTable> GetAllDataForGenerateOrder(ITIFlyingSquadSearchModel body)
        {
            _actionName = "GetAllData()";
            try
            {
        ...
        public async Task<DataSet> GenerateFlyingSquadDutyOrder(List<ITICOFlyinDeploymentDataModel> model)
        {
            _actionName = "GenerateFlyingSquadDutyOrder(GenerateDutyOrder model)";
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_FlyingSquad_GenerateDutyOrder";
        ...
        public async Task<int> UpdateDutyOrder(List<ITICOFlyinDeploymentDataModel> model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Set the stored procedure name and type
                        command.CommandText = "USP_ITI_FlyingSquad_UpdateDutyOrder";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<DataSet> GenerateCOAnsweredReport(ITIFlyingSquadSearchModel model)
        {
        ...
        public async Task<DataTable> GetTimeTableDates(ITIFlyingSquadSearchModel body)
        {
            _actionName = "GetAllData()";
            try
            {
        ...
        public async Task<bool> DeleteDeploymentDataByID(ITIFlyingSquadDataModel model)
        {
            _actionName = "GetById(int PK_ID)";
            return await Task.Run(async () =>
            {
        ...
        //            {
        //                // Set the stored procedure name and type
        //                command.CommandText = "USP_FlyingSquadDeployment_ForwardToVerify";
        //                command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<bool> UpdateAttendance(UpdateAttendance model)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_ITI_FlyingSquad_UpdateAttendance";
                        command.Parameters.AddWithValue("@IsPresent", model.IsPresent);
                        command.Parameters.AddWithValue("@Remark", model.Remark);
                        command.Parameters.AddWithValue("@IPAddress", _IPAddress);
                        command.Parameters.AddWithValue("@FSAttendanceID", model.COAttendanceID);
        ...
        public async Task<int> ApproveRequest(int DeplomentId)
        {
            _actionName = "IsRequestFlyingSquad()";
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.Parameters.AddWithValue("@DeploymentID", DeplomentId);
