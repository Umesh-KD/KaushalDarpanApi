...
{
    public class ITIPlacementStudentRepository : I_ITIPlacementStudentRepository
    {
        ...
        public ITIPlacementStudentRepository(DBContext dbContext)
        {
            _dbContext = dbContext;
            _pageName = "ITIPlacementStudentRepository";
            _IPAddress = CommonFuncationHelper.GetIpAddress();
        }

        public async Task<List<ITIPlacementStudentResponseModel>> GetAllData(ITIPlacementStudentSearchModel searchModel)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    var data = new List<ITIPlacementStudentResponseModel>();
                    if (dataTable != null)
                    {
                        data = CommonFuncationHelper.ConvertDataTable<List<ITIPlacementStudentResponseModel>>(dataTable);
                    }
                    return data;
                }
                catch (Exception ex)
        ...
        public async Task<DataTable> GetPlacementconsent(ITIStudentConsentSearchmodel body)
        {
            _actionName = "GetPlacementconsent(ITIStudentConsentSearchmodel body)";
            try
            {
                return await Task.Run(async () =>
                {
                    ...
                    {
                        command.CommandType = CommandType.StoredProcedure;
                        command.CommandText = "USP_GetITIPlacementconsent";
                        command.Parameters.AddWithValue("@Action", body.action);
                        command.Parameters.AddWithValue("@CompanyID", body.CompanyID);
                        command.Parameters.AddWithValue("@PostID", body.PostID);
                        command.Parameters.AddWithValue("@CollegeID", body.CollegeID);
        ...
        public async Task<int> SaveData(ITICampusStudentConsentModel entity)
        {
            ...
            return await Task.Run(async () =>
            {
                try
                {
                    ...
                    using (var command = _dbContext.CreateCommand(true))
                    {
                        ...
                        command.CommandText = "USP_ITICampusStudentConsent_IU";
                        command.CommandType = CommandType.StoredProcedure;
        ...
        //public Task<int> SaveData(ITICampusStudentConsentModel productDetails)
        //{
