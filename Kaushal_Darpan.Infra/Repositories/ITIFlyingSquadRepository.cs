...
{
    public class ITIFlyingSquadRepository: IITIFlyingSquadRepository
    {
        ...
        public ITIFlyingSquadRepository(DBContext dbContext)
        {
            _dbContext = dbContext;
            _pageName = "ITIFlyingSquadRepository";
        ...
        public async Task<DataTable> GetTeamFlyingSquad(GetTeamFlyingSquadModal model)
        {
