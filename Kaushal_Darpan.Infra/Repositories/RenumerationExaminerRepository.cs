...
namespace Kaushal_Darpan.Infra.Repositories
{
    public class RenumerationExaminerRepository : IRenumerationExaminerRepository
    {
        ...
        {
            _actionName = "GetTrackStatusData(RenumerationExaminerRequestModel filterModel)";
            try
            {
        ...
        public async Task<List<RenumerationExaminerModel>> GetAllData_Reval(RenumerationExaminerRequestModel filterModel)
        {
            _actionName = "GetAllData_Reval(RenumerationExaminerRequestModel filterModel)";
            try
            {
                List<RenumerationExaminerModel> obj = new List<RenumerationExaminerModel>();
                DataTable dt = new DataTable();
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_RenumerationExaminerGroupCode_Reval";
        ...
        public async Task<List<TrackStatusDataModel>> GetTrackStatusData_Reval(RenumerationExaminerRequestModel filterModel)
        {
            _actionName = "GetTrackStatusData_Reval(RenumerationExaminerRequestModel filterModel)";
            try
            {
                List<TrackStatusDataModel> obj = new List<TrackStatusDataModel>();
                DataTable dt = new DataTable();
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "usp_Trackstatus_GetRenumerationExaminer_Reval";
        ...
        public async Task<DataTable> GetDataForGeneratePdf_Reval(RenumerationExaminerRequestModel filterModel)
        {
            _actionName = "GetDataForGeneratePdf_Reval(RenumerationExaminerRequestModel filterModel)";
            try
            {
                DataTable dt = new DataTable();
                using (var command = await _dbContext.CreateCommandAsync())
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "USP_ReptGetExaminerReport_Reval";
        ...
        public async Task<int> SaveDataSubmitAndForwardToJD_Reval(RenumerationExaminerPDFModel request)
        {
            _actionName = "SaveDataSubmitAndForwardToJD_Reval(RenumerationExaminerPDFModel request)";
            try
            {
                int result = 0;
                using (var command = await _dbContext.CreateCommandAsync(true))
