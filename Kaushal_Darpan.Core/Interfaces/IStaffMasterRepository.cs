...
namespace Kaushal_Darpan.Core.Interfaces
{
    public interface IStaffMasterRepository
    {
        ...
        Task<DataTable> GetAllRoomUtilizationReport(GetAllRosterDisplayModel body);
        Task<DataTable> GetAllRoomReport(GetAllRosterDisplayModel body);
        ...
        Task<DataTable> GetAssignedTeacherForSubject_History(GetAssignedTeacherForSubjectDataModel body);
        ...
        Task<DataTable> GetBranchSectionAcRosterData_MulitpleSub(GetDDlSectionDataModel body);
