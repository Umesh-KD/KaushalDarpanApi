...
namespace Kaushal_Darpan.Core.Interfaces
{
    public interface ICommonFunctionRepository
    {
        ...
        Task<DataTable> StreamMaster(int DepartmentID = 0, int StreamType = 0, int EndTermId = 0, bool IsForEstablishment = false);
        ...
        Task<DataTable> StaffAttendence(string SSOID= "", int StreamType = 0, int EndTermId = 0, int InstituteID=0,int RoleID=0);
        ...
        Task<DataTable> GetActiveTradeList(ItiTradeSearchModel request);
