...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    {
        public override string PageName => "CompanyMasterController";
        public override string ActionName { get; set; }

        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public CompanyMasterController(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
        ...
        //public async Task<ApiResult<CompanyMasterResponsiveModel>> GetByID(int PK_ID)
        //{
        //    ActionName = "GetByID(int PK_ID)";
        //    return await Task.Run(async () =>
        //    {
        //        var result = new ApiResult<CompanyMasterResponsiveModel>();
        //        try
        //        {
        //            var data = await _unitOfWork.CompanyMasterRepository.GetById(PK_ID);
        //            result.Data = data;
        //            if (data != null)
        //            {
        //                result.State = EnumStatus.Success;
        ...
        [HttpPost("GetByID")]
        public async Task<ApiResult<CompanyMasterModels>> GetByID(CompanyMasterSearchModel req)
        {
            ActionName = "GetByID(int PK_ID)";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.CompanyMasterRepository.GetByID(req);
                    result.Data = data;
                    if (data != null)
                    {
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<bool>> DeleteByID(int ID, int ModifyBy)
        {
            ...
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var mappedData = new CompanyMasterModels
                    {
                        ID = ID,
                        ModifyBy = ModifyBy,
                    ...
                    result.Data = await _unitOfWork.CompanyMasterRepository.DeleteDataByID(mappedData);
                    await _unitOfWork.SaveChangesAsync();
        ...
        public async Task<ApiResult<bool>> Save_CompanyValidation_NodalAction([FromBody] CompanyMaster_Action request)
        {
            ...
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    result.Data = await _unitOfWork.CompanyMasterRepository.Save_CompanyValidation_NodalAction(request);
                    await _unitOfWork.SaveChangesAsync();
                    if (result.Data)
                    {
                        result.State = EnumStatus.Success;
        ...
        [HttpPost("CompanyValidationList")]
        public async Task<ApiResult<DataTable>> CompanyValidationList([FromBody] CompanyMasterSearchModel body)
        {
            ActionName = "GetAllData()";
            var result = new ApiResult<DataTable>();
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.CompanyMasterRepository.CompanyValidationList(body));
                result.State = EnumStatus.Success;
                if (result.Data.Rows.Count == 0)
                {
                    result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<DataTable>> CompanyMasterReport([FromBody] CompanyMasterSearchModel body)
        {
            ActionName = "CompanyMasterReport([FromBody] CompanyMasterSearchModel body)";
            var result = new ApiResult<DataTable>();
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.CompanyMasterRepository.CompanyMasterReport(body));
                result.State = EnumStatus.Success;
                if (result.Data.Rows.Count == 0)
                {
                    result.State = EnumStatus.Success;
        ...
        [HttpPost("GetPlacementAllStudentList")]
        public async Task<ApiResult<DataTable>> GetPlacementAllStudentList([FromBody] PlacementStudentListSearchModel body)
        {
            ActionName = "GetPlacementAllStudentList()";
            var result = new ApiResult<DataTable>();
            try
            {

                // Pass the entire model to the repository
                result.Data = await _unitOfWork.CompanyMasterRepository.GetPlacementAllStudentList(body);
