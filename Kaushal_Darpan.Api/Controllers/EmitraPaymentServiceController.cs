...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class EmitraPaymentServiceController : BaseController
    {
        ...
        #region "ITI EXAM FEES VERIFICATOPM"

        [HttpPost("ITINCVTEXAMVerification")]
        public async Task<ApiResult<EmitraResponseParametersModel>> ITINCVTEXAMVerification(RPPTransactionStatusDataModel Model)
        {
            string RESPONSEJSON;
            ActionName = "GetTransactionStatus(RPPTransactionStatusDataModel Model)";
            var result = new ApiResult<EmitraResponseParametersModel>();
            ...
            try
            {
                ...
                if (data != null && data.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow Dr in data.Rows)
                    {
                        ...
                        objStudentFeesTransactionItems.Gender = Dr["GenderName"].ToString();
                        ...
                        objStudentFeesTransactionItems.TranSemesterID = int.Parse(Dr["SemesterID"].ToString());
                        objStudentFeesTransactionItems.TransactionApplicationID = int.Parse(Dr["StudentSemesterID"].ToString());
                    ...
                    if (LstStudentFeesTransaction.Count > 0)
                    {
                        ...
                        objEmitra.ExamStudentStatus = emitraRequestDetailsModel.ExamStudentStatus;
        ...
        public async Task<ApiResult<dynamic>> GetStudentDeatilsByActionWhatsapp_ITI(StudentSearchModelForWhatsAPP body)
        {
            ...
            try
            {
                ...
                {
                    requestDetailsModel.State = EnumStatus.Error;
                    requestDetailsModel.Message = Constants.MSG_ADD_ERROR;
                }
            }
            catch (System.Exception ex)
            {
