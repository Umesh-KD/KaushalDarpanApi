...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class EmitraPaymentServiceController : BaseController
    {
        ...
        {
            ActionName = "EnrollmentExaminationFeePayment(EmitraRequestDetailsModel Model)";
            var requestDetailsModel = new ApiResult<EmitraRequestDetailsModel>();
            try
            {
        ...
        [HttpPost("EnrollmentExaminationFeePaymentResponse")] //IActionResult
        public async Task<IActionResult> EnrollmentExaminationFeePaymentResponse(string UniquerequestId = "", string ApplicationIdEnc = "", string ServiceID = "", string IsFailed = "", string UniqueServiceID = "")
        {
            var RetrunUrL = "";
            try
            {
        ...
        #region emitra reval fee payment by student 
        [HttpPost("RevalFeePayment_Student")]
        public async Task<ApiResult<EmitraRequestDetailsModel>> RevalFeePayment_Student(EmitraRequestDetailsModel Model)
        {
        ...
        [HttpPost("RevalFeePaymentResponse")] //IActionResult
        public async Task<IActionResult> RevalFeePaymentResponse(string UniquerequestId = "", string ApplicationIdEnc = "", string ServiceID = "", string IsFailed = "", string UniqueServiceID = "")
        {
            var RetrunUrL = "";
            try
            {
        ...
        #region emitra reval fee payment by kiosk
        [HttpPost("RevalFeePayment_Kiosk")]
        public async Task<ApiResult<EmitraRequestDetailsModel>> RevalFeePayment_Kiosk(EmitraRequestDetailsModel Model)
        {
            ActionName = "RevalFeePayment_Kiosk(EmitraRequestDetailsModel Model)";
            var requestDetailsModel = new ApiResult<EmitraRequestDetailsModel>();
            try
            {
                Model.IsKiosk = true;
        ...
        public async Task<IActionResult> EnrollmentExaminationFeePayment(string UniquerequestId = "", string ServiceID="")
        {
            var RetrunUrL = "";
            try
            {
                ...
                EmitraRequestDetailsModel Model = new EmitraRequestDetailsModel();
                Model.ServiceID = ServiceID;
                Model.ID = string.IsNullOrEmpty(UniquerequestId) == true ? 0 : Convert.ToInt32(UniquerequestId);
        ...
        public async Task<ApiResult<dynamic>> GetStudentDeatilsByAction([FromBody] StudentSearchModel body)
        {
            ...
            try
            {
                ...
                {
                    var row = data.Rows[0];
                    EmitraRequestDetailsModel emitraRequestDetailsModel = new EmitraRequestDetailsModel();
                    emitraRequestDetailsModel.ServiceID = (string)row["ServiceID"];
                    ...
                    emitraRequestDetailsModel.ID = (int)row["ID"];

                    var EmitraServiceDetail = await _unitOfWork.CommonFunctionRepository.GetEmitraServiceDetailsWhatsapp(emitraRequestDetailsModel);

                    Decimal FinalAmount = 0;
                    string TransactionApplicationID = "";
                    List<StudentFeesTransactionItems> LstStudentFeesTransaction = new List<StudentFeesTransactionItems>();

                    foreach (DataRow Dr in data.Rows)
                    {
                        FinalAmount = FinalAmount + decimal.Parse(Dr["ItemAmount"].ToString());
                        StudentFeesTransactionItems objStudentFeesTransactionItems = new StudentFeesTransactionItems();
                    ...
                    objEmitra.Amount = FinalAmount; //exam fees
                    //objEmitra.EnrollFeeAmount = (Model.EnrollFeeAmount ?? 0);//enroll fees
                    ...
                    objEmitra.StudentFeesTransactionItems = LstStudentFeesTransaction;
                    objEmitra.SSOID = "";
                    ...
                    var SUCCESSURL = row["WhatsappResponseURL"].ToString() + "?UniquerequestId=" + CommonFuncationHelper.EmitraEncrypt(Convert.ToString(UpdateStatus.TransactionId)) + "&ServiceID=" + (string)row["ServiceID"];
                    // data.FAILUREURL = EmitraServiceDetail.REDIRECTURL + "?UniquerequestId=" + CommonFuncationHelper.EmitraEncrypt(Convert.ToString(result.TransactionId)) + "&ApplicationIdEnc=" + CommonFuncationHelper.EmitraEncrypt(Model.ApplicationIdEnc) + "&ServiceID=" + Model.ServiceID.ToString() + "&IsFailed=" + CommonFuncationHelper.EmitraEncrypt("YES") + "&UniqueServiceID=" + Model.ID.ToString();

                    result.Data = new { PRN = objEmitra.PRN, Amount = FinalAmount, CallBackUrl = SUCCESSURL };
                }
                else
                {
                    result.State = EnumStatus.Warning;
