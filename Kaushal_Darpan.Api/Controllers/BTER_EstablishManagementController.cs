...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class BTER_EstablishManagementController : BaseController
    {
        ...
        public async Task<ApiResult<int>> Save_M_OfficeVacancy_IU([FromBody] List<OfficeVacancyModel> body)
        {
        ...
        public async Task<ApiResult<DataTable>> OfficeVacancyList(OfficeVacancyModel model)
        {
            ...
            try
            {
                ...
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.BTER_EstablishManagementRepository.OfficeVacancyList(model);
        ...
        public async Task<ApiResult<int>> DeleteOfficeVacancy([FromBody] OfficeVacancyModel body)
        {
        ...
        [HttpPost("BTER_EM_ApproveStaffProfileOterFaculty")]
        public async Task<ApiResult<int>> BTER_EM_ApproveStaffProfileOterFaculty([FromBody] BTER_EM_ApproveStaffDataModel body)
        {

            ActionName = "BTER_EM_ApproveStaffProfileOterFaculty([FromBody] BTER_EM_ApproveStaffDataModel body)";
            var result = new ApiResult<int>();
            try
            {
                result.Data = await _unitOfWork.BTER_EstablishManagementRepository.BTER_EM_ApproveStaffProfileOterFaculty(body);
                await _unitOfWork.SaveChangesAsync();
                if (result.Data > 0)
                {
                    result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<DataTable>> GetBudgetHeadMasterData_EM([FromBody] EM_BudgetHeadMasterDataModel body)
        {

            ActionName = "GetBudgetHeadMasterData_EM([FromBody] EM_BudgetHeadMasterDataModel body)";
            var result = new ApiResult<DataTable>();
            try
            {

                // Pass the entire model to the repository
                result.Data = await _unitOfWork.BTER_EstablishManagementRepository.GetBudgetHeadMasterData_EM(body);
        ...
        public async Task<ApiResult<DataTable>> GetBudgetHeadById_EM(int id)
        {
            ...
            try
            {
                var data = await _unitOfWork.BTER_EstablishManagementRepository.GetBudgetHeadById_EM(id);
        ...
        {
            ActionName = "Bter_EM_GetCommonDropdownData(EM_CommonDropdownDataModel model)";
            var result = new ApiResult<DataTable>();
            try
            {

                // Pass the entire model to the repository
                result.Data = await _unitOfWork.BTER_EstablishManagementRepository.Bter_EM_GetCommonDropdownData(model);
        ...
        [HttpPost("GetEstablishmentReportData")]
        public async Task<ApiResult<DataTable>> GetEstablishmentReportData([FromBody] BTER_EM_GetStaffListDataModel body)
        {

            ActionName = "GetEstablishmentReportData([FromBody] BTER_EM_GetStaffListDataModel body)";
            var result = new ApiResult<DataTable>();
            try
            {

                // Pass the entire model to the repository
                result.Data = await _unitOfWork.BTER_EstablishManagementRepository.GetEstablishmentReportData(body);
