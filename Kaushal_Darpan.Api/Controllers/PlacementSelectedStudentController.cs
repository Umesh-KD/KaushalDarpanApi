...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class PlacementSelectedStudentController : BaseController
    {
        public override string PageName => "PlacementSelectedStudentController";
        public override string ActionName { get; set; }

        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public PlacementSelectedStudentController(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
        ...
        [HttpPost("GetAllData")]
        public async Task<ApiResult<List<PlacementSelectedStudentResponseModel>>> GetAllData(PlacementSelectedStudentSearchModel searchModel)
        {
            ActionName = "GetAllData([FromBody] PlacementSelectedStudentSearchModel searchModel)";
            var result = new ApiResult<List<PlacementSelectedStudentResponseModel>>();
            try
            {
        ...
        public async Task<ApiResult<DataTable>> GetStudentPlacedCount()
        {
            ActionName = "GetStudentPlacedCount()";
            var result = new ApiResult<DataTable>();
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.PlacementSelectedStudentRepository.GetStudentPlacedCount());
                result.State = EnumStatus.Success;
