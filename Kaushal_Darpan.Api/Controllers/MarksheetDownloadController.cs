...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class MarksheetDownloadController : BaseController
    {
        ...
        public async Task<ApiResult<string>> MarksheetLetterDownload([FromBody] MarksheetDownloadSearchModel model)
        {
            ...
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    var sb = await _printHtmlFile.GetMArksheetLetterhHtml(data);
        ...
        #region  Marksheet Letter OLD
        [HttpPost("GetMarksheetLetterNewOld")]
        public async Task<ApiResult<string>> GetMarksheetLetterNewOld([FromBody] MarksheetDownloadSearchModel model)
        {
            ActionName = "GetMarksheetLetterNewOld([FromBody] MarksheetDownloadSearchModel model)";
            var folderPath = $"{ConfigurationHelper.StaticFileRootPath}{Constants.ReportsFolder}";
            return await Task.Run(async () =>
            {
                var result = new ApiResult<string>();
