...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class CollegeWiseScholarshipController : BaseController
    {
        public override string PageName => "CollegeWiseScholarshipController";
        public override string ActionName { get; set; }

        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public CollegeWiseScholarshipController(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
        ...
        public async Task<ApiResult<DataTable>> GetCollegeWiseScholarshipList([FromBody] CollegeWiseScholarshipSearchModel body)
        {
