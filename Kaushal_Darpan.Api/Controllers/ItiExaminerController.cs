...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class ItiExaminerController : BaseController
    {
        ...
        //        public async Task<IActionResult> TeacherForExaminerReportDewnloadPdf([FromBody] ITITeacherForExaminerSearchModel body)
        //        {
        //            try
        //            {


        //                var streams_data = await _unitOfWork.ItiExaminerRepository.GetTeacherForExaminerReport(body);


        //                var dataList = CommonFuncationHelper.ConvertDataTable<List<ITITeacherForExaminerSearchModel>>(streams_data.Tables[0]);
        ...
        //    <div class='header'>
        //        <div>SCVT Examination (Yearly) First - July 2025 <span style=""margin-left:auto;display:block;float:right "">Center Code: <b>0126</b></span></div>
        //    </div>

        //    <div class='sub-header'>
        //        <div>Examiner Code: <b>50942</b> <span style=""margin-left:auto;display:block;float:right "">Subject: <b>Paper-I: Employability Skills</b></span></div>
        //    </div>

        //    <div class='sub-header'>
        //        <div>Trade: <b>Refrigeration & Air Conditioning Technician</b>  <span style=""margin-left:auto;display:block;float:right ""> Maximum Marks:50</span></div>
        //        <div></div>
        //    </div>
        ...
        //        <table width='100%'>
        //            <tr>
        //                <td class='text-left'>Name: <b>SALEEM AHMED</b></td>
        //                <td class='text-left'> <span style=""margin-left:auto;display:block;float:right "">Date: <span class='line'></span></span></td>
        //            </tr>
        //            <tr>
        //                <td class='text-left'>Post: <span class='line'></span></td>

        //            </tr>
        //            <tr>
        //                <td class='text-left'>Mobile No: <b>9252084643</b></td>
        //                <td class='text-left'><span style=""margin-left:auto;display:block;float:right "">Signature: <span class='line'></span></span></td>
        //                <td></td>
        //            </tr>
        //        </table>
        //    </div>
...
//        public async Task<IActionResult> TeacherForExaminerReportDewnloadPdf121212([FromBody] ITITeacherForExaminerSearchModel body)
//        {
//            try
//            {
...
//                var groupedData = dataList.GroupBy(x => new{x.SubjectCode, x.StreamID,x.SemesterID});
...
//    <div>
//        <b>SCVT Examination (Yearly) First - July 2025</b>
//        <span style='float:right'>Center Code: <b>{header.CenterCode}</b></span>
//    </div>

//    <div>
//        Examiner Code: <b>{header.ExaminerCode}</b>
//        <span style='float:right'>Subject: <b>{header.SubjectName}</b></span>
//    </div>

//    <div>
//        Trade: <b>{header.SubjectName}</b>
//        <span style='float:right'>Maximum Marks: <b>{header.MaxMarks}</b></span>
//    </div>
