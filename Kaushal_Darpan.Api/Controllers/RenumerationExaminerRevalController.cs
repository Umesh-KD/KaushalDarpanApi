...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class RenumerationExaminerRevalController : BaseController
    {
        public override string PageName => "RenumerationExaminerRevalController";
        public override string ActionName { get; set; }

        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public RenumerationExaminerRevalController(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
        ...
        public async Task<ApiResult<List<RenumerationExaminerModel>>> GetAllData([FromBody] RenumerationExaminerRequestModel filterModel)
        {
            ...
            try
            {
                ...
                var data = await _unitOfWork.RenumerationExaminerRepository.GetAllData_Reval(filterModel);
        ...
        public async Task<ApiResult<List<TrackStatusDataModel>>> GetTrackStatusData([FromBody] RenumerationExaminerRequestModel filterModel)
        {
            ...
            {
                // Pass the entire model to the repository
                var data = await _unitOfWork.RenumerationExaminerRepository.GetTrackStatusData_Reval(filterModel);
