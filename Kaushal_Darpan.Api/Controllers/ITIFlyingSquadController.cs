...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    [ApiController]
    public class ITIFlyingSquadController : BaseController
    {
        public override string PageName => "ITIFlyingSquadController";
        public override string ActionName { get; set; }

        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public ITIFlyingSquadController(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
        ...
        public async Task<ApiResult<DataTable>> GetFlyingSquad([FromBody] GetFlyingSquadModal filterModel)
        {
            ...
            try
            {
                ...
                result.Data = await _unitOfWork.ITIFlyingSquadRepository.GetFlyingSquad(filterModel);
        ...
        public async Task<ApiResult<int>> PostFlyingSquad([FromBody] PostFlyingSquadModal model)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.PostFlyingSquad(model);
        ...
        public async Task<ApiResult<int>> SetInchargeFlyingSquad(int ID,int TeamID, int Incharge)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.SetInchargeFlyingSquad(ID, TeamID, Incharge);
                    _unitOfWork.SaveChanges();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<int>> PostTeamFlyingSquadForm([FromBody] PostTeamFlyingSquadModal model)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.PostTeamFlyingSquadForm(model);
                    _unitOfWork.SaveChanges();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<DataTable>> GetTeamFlyingSquad([FromBody] GetTeamFlyingSquadModal filterModel)
        {
            ActionName = "GetAllData([FromBody] CenterCreationResponseModel filterModel)";
            var result = new ApiResult<DataTable>();
            try
            {
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIFlyingSquadRepository.GetTeamFlyingSquad(filterModel);
        ...
        public async Task<ApiResult<int>> PostTeamDeploymentFlyingSquadForm([FromBody] PostTeamFlyingSquadModal model)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.PostTeamDeploymentFlyingSquadForm(model);
                    _unitOfWork.SaveChanges();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<int>> PostTeamDeploymentFlyingSquad(List<PostTeamFlyingSquadUpdateModal> model)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.PostTeamDeploymentFlyingSquad(model);
                    _unitOfWork.SaveChanges();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<DataTable>> GetTeamDeploymentFlyingSquad([FromBody] GetTeamFlyingSquadModal filterModel)
        {
            ...
            {
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIFlyingSquadRepository.GetTeamDeploymentFlyingSquad(filterModel);
        ...
        public async Task<ApiResult<DataTable>> GetFlyingSquad_Attendance([FromBody] GetFlyingSquadAttendance filterModel)
        {
            ...
            {
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIFlyingSquadRepository.GetFlyingSquad_Attendance(filterModel);
        ...
        public async Task<ApiResult<int>> UpdateFlyingSquad_Attendance([FromBody] UpdateFlyingSquadAttendance model)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.UpdateFlyingSquad_Attendance(model);
                    _unitOfWork.SaveChanges();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<int>> PostFlyingSquadAttendanceForm([FromBody] PostFlyingSquadAttendanceModal model)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.PostFlyingSquadAttendanceForm(model);
                    _unitOfWork.SaveChanges();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<int>> IsRequestFlyingSquad([FromBody] PostIsRequestFlyingSquadModal model)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.ITIFlyingSquadRepository.IsRequestFlyingSquad(model);
                    //var data1 = await _unitOfWork.ITIFlyingSquadRepository.IsRequestHistoryFlyingSquad(model);
