...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class CommonFunctionController : BaseController
    {
        ...
        [HttpGet("MultiStreamMasterHOD/{UserID}/{StreamType}/{EndTermId}/{SemesterID}/{InstituteId}")]
        public async Task<ApiResult<DataTable>> MultiStreamMasterHOD(int UserID = 0, int StreamType = 0, int EndTermId = 0, string SemesterID = "", int InstituteId = 0)
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<DataTable>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.MultiStreamMasterHOD(UserID, StreamType, EndTermId, SemesterID, InstituteId);
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<DataTable>> SemesterList(int DepartmentID = 0)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.SemesterList(DepartmentID);
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpGet("CenterCodeMaster")]
        public async Task<ApiResult<DataTable>> CenterCodeMaster()
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<DataTable>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.CenterCodeMaster();
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpGet("SectorWiseTradeCode")]
        public async Task<ApiResult<DataTable>> SectorWiseTradeCode()
        {
            ActionName = "SectorWiseTradeCode()";
            return await Task.Run(async () =>
            {
                var result = new ApiResult<DataTable>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.SectorWiseTradeCode();
                    if (data != null)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpGet("SectorWiseTrades/{DepartmentID}/{SectorID}")]
        public async Task<ApiResult<DataTable>> SectorWiseTrades(int DepartmentID, int SectorID)
        {
            ActionName = "GetCampusPostMasterDDL()";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.SectorWiseTrades(DepartmentID, SectorID);
                    if (data != null)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<List<CommonDDLModel>>> GetGroupCode(CommonDDLSubjectMasterModel model)
        {
            ...
            try
            {
                var data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.GetGroupCode(model));
                if (data != null)
                {
                    result.Data = data;
                    result.State = EnumStatus.Success;
        ...
        [HttpGet("GetNonsubstitutesubject/{SSOID}/{EndTermID}/{SemesterID}/{Eng_NonEng}/{StreamID}")]
        public async Task<ApiResult<List<CommonDDLModel>>> GetNonsubstitutesubject(string SSOID, int EndTermID, int SemesterID, int Eng_NonEng, int StreamID)
        {
            ActionName = "SubjectMaster_StreamIDWise(int StreamID)";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.GetNonsubstitutesubject(SSOID, EndTermID, SemesterID, Eng_NonEng, StreamID);
                    if (data != null)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpGet("GetStudentAttandanceTimeDDL/{StaffID}/{SubjectID}/{StreamID}/{SectionID}")]
        public async Task<ApiResult<DataTable>> GetStudentAttandanceTimeDDL(int StaffID, int SubjectID,int StreamID,int SectionID)
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<DataTable>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.GetStudentAttandanceTimeDDL(StaffID, SubjectID, StreamID, SectionID);
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<DataTable>> GetStaff_InstituteAndWorkWise([FromBody] StaffMasterDDLDataModel body)
        {
            ...
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.GetStaff_InstituteAndWorkWise(body));
                result.State = EnumStatus.Success;
                if (result.Data.Rows.Count == 0)
                {
                    result.State = EnumStatus.Success;
        ...
        [HttpPost("GetStaff_InstituteAcRoster")]
        public async Task<ApiResult<DataTable>> GetStaff_InstituteAcRoster([FromBody] StaffMasterDDLDataModel body)
        {
            ActionName = "GetAllData()";
            var result = new ApiResult<DataTable>();
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.GetStaff_InstituteAcRoster(body));
                result.State = EnumStatus.Success;
                if (result.Data.Rows.Count == 0)
                {
                    result.State = EnumStatus.Success;
        ...
        [HttpPost("GetHostelStatusDDL")]
        public async Task<ApiResult<DataTable>> GetHostelStatusDDL()
        {
            ActionName = " GetHostelStatusDDL()";
            var result = new ApiResult<DataTable>();
            try
            {
        ...
        [HttpGet("DDL_ITI_GovtEMDDLOfficeVacancy/{DepartmentID}/{LevelID}")]
        public async Task<ApiResult<List<CommonDDLModel>>> DDL_ITI_GovtEMDDLOfficeVacancy(int DepartmentID, int LevelID)
        {
            ActionName = "DDL_ITI_GovtEMDDLOfficeVacancy()";
            return await Task.Run(async () =>
            {
                var result = new ApiResult<List<CommonDDLModel>>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.DDL_ITI_GovtEMDDLOfficeVacancy(DepartmentID, LevelID);
                    if (data != null)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpGet("DivisionData_ByDistrict/{DistrictID}")]
        public async Task<ApiResult<DataTable>> DivisionData_ByDistrict(int DistrictID)
        {
            ActionName = "DivisionData_ByDistrict(int DistrictID)";
            var result = new ApiResult<DataTable>();
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.DivisionData_ByDistrict(DistrictID));
                result.State = EnumStatus.Success;
                if (result.Data.Rows.Count == 0)
                {
                    result.State = EnumStatus.Success;
        ...
        [HttpGet("GetITIPostDepartmentWise/{DepartmentID}")]
        public async Task<ApiResult<List<CommonDDLModel>>> GetITIPostDepartmentIDWise(int DepartmentID)
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<List<CommonDDLModel>>();
        ...
        [HttpGet("GetBterPostMaster")]
        public async Task<ApiResult<List<CommonDDLModel>>> GetBterPostMaster()
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<List<CommonDDLModel>>();
        ...
        [HttpGet("GetDDLCounselling_Qualification")]
        public async Task<ApiResult<DataTable>> GetDDLCounselling_Qualification()
        {
            ActionName = "GetDDLCounselling_Qualification()";
            var result = new ApiResult<DataTable>();
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.GetDDLCounselling_Qualification());
                result.State = EnumStatus.Success;
                if (result.Data.Rows.Count == 0)
                {
                    result.State = EnumStatus.Success;
        ...
        [HttpGet("DDL_AllCasteCategoryA")]
        public async Task<ApiResult<DataTable>> DDL_AllCasteCategoryA()
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<DataTable>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.DDL_AllCasteCategoryA();
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        public async Task<ApiResult<DataTable>> DDL_Counselling_Trade(int designationId)
        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.DDL_Counselling_Trade(designationId);
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpGet("GetZonalID/{UserID}/{EndTermID}")]
        public async Task<ApiResult<DataTable>> GetZonalID(int UserID, int EndTermID)
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<DataTable>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.GetZonalID(UserID, EndTermID);
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        //For Private
        [HttpPost("ITI_DeirectAdmissionOptionFormData_Private")]
        public async Task<ApiResult<DataTable>> ITI_DeirectAdmissionOptionFormData_Private([FromBody] ItiTradeSearch_PrivateModel body)
        {
            ActionName = "ITI_DeirectAdmissionOptionFormData_Private([FromBody] ItiTradeSearch_PrivateModel body)";
            var result = new ApiResult<DataTable>();
            try
            {
                result.Data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.ITI_DeirectAdmissionOptionFormData_Private(body));
                result.State = EnumStatus.Success;
                if (result.Data.Rows.Count == 0)
                {
                    result.State = EnumStatus.Success;
        ...
        [HttpPost("CommonMasterDataByAction")]
        public async Task<ApiResult<DataTable>> CommonMasterDataByAction(CommonMasterModel model)

        {
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.CommonMasterDataByAction(model);
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpPost("GetGroupCode_Reval")]
        public async Task<ApiResult<List<CommonDDLModel>>> GetGroupCode_Reval(CommonDDLSubjectMasterModel model)
        {
            ActionName = "GetGroupCode_Reval(CommonDDLSubjectMasterModel model)";
            var result = new ApiResult<List<CommonDDLModel>>();
            try
            {
                var data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.GetGroupCode_Reval(model));
                if (data != null)
                {
                    result.Data = data;
                    result.State = EnumStatus.Success;
        ...
        [HttpGet("DDL_EmployeeTransferSysterm/{OfficeID}/{DesignationID}/{DistrictID}/{InstituteID}")]
        public async Task<ApiResult<DataTable>> DDL_EmployeeTransferSysterm(int OfficeID = 0, int DesignationID = 0, int DistrictID = 0, int InstituteID = 0)
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<DataTable>();
                try
                {
                    var data = await _unitOfWork.CommonFunctionRepository.DDL_EmployeeTransferSysterm(OfficeID, DesignationID, DistrictID, InstituteID);
                    if (data.Rows.Count > 0)
                    {
                        result.Data = data;
                        result.State = EnumStatus.Success;
        ...
        [HttpGet("GetAlreadyAssignedOptionalSubject/{StudentExamID}")]
        public async Task<ApiResult<DataTable>> GetAlreadyAssignedOptionalSubject(int StudentExamID)
        {
            var result = new ApiResult<DataTable>();
            try
            {
                var data = await Task.Run(() => _unitOfWork.CommonFunctionRepository.GetAlreadyAssignedOptionalSubject(StudentExamID));
                if (data != null)
                {
                    result.Data = data;
                    result.State = EnumStatus.Success;
