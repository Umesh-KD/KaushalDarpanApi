    ...
    public class StudentController : BaseController
    {
        ...
        public async Task<ApiResult<DataTable>> GetStudentAttendanceReport([FromBody] AttendanceTimeTableModal request)
        {
            ...
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    result.Data = await _unitOfWork.StudentRepository.GetStudentAttendanceReport(request);
                    //var holidayData = await _unitOfWork.StudentRepository.GetHolidaysmaster(request.AttendanceStartDate, request.AttendanceEndDate);
        ...
        [HttpPost("GetStudentAttendance_ITIReport")]
        public async Task<ApiResult<DataTable>> GetStudentAttendance_ITIReport([FromBody] AttendanceTimeTableModal request)
        {
            ActionName = "GetStudentAttendance()";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    result.Data = await _unitOfWork.StudentRepository.GetStudentAttendance_ITIReport(request);
                    //var holidayData = await _unitOfWork.StudentRepository.GetHolidaysmaster(request.AttendanceStartDate, request.AttendanceEndDate);
        ...
        [HttpPost("GetTeacherAttendence")]
        public async Task<ApiResult<DataTable>> GetTeacherAttendence([FromBody] AttendanceTimeTableModal request)
        {
            ActionName = "GetStudentAttendance()";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    result.Data = await _unitOfWork.StudentRepository.GetTeacherAttendence(request);
                    //var holidayData = await _unitOfWork.StudentRepository.GetHolidaysmaster(request.AttendanceStartDate, request.AttendanceEndDate);
        ...
        [HttpPost("GetStudentAttendance_PercentReport")]
        public async Task<ApiResult<DataTable>> GetStudentAttendance_PercentReport([FromBody] AttendanceTimeTableModal request)
        {
            ActionName = "GetStudentAttendance()";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    result.Data = await _unitOfWork.StudentRepository.GetStudentAttendance_PercentReport(request);
                    //var holidayData = await _unitOfWork.StudentRepository.GetHolidaysmaster(request.AttendanceStartDate, request.AttendanceEndDate);
            ...
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
                        result.Data = data;
                        result.Message = "Attendance Mark Successfully";
        ...
        [HttpPost("SetCalendarEventModelITI")]
        public async Task<ApiResult<int>> SetCalendarEventModelITI([FromBody] List<CalendarEventModel> model)
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<int>();
                try
                {
                    var data = await _unitOfWork.StudentRepository.SetCalendarEventModelITI(model);
                    await _unitOfWork.SaveChangesAsync();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        [HttpPost("UpdateCalendarEventModelBter")]
        public async Task<ApiResult<int>> UpdateCalendarEventModelBter([FromBody] List<CalendarEventModelITI> model)
        {
            return await Task.Run(async () =>
            {
                var result = new ApiResult<int>();
                try
                {
                    var data = await _unitOfWork.StudentRepository.UpdateCalendarEventModelBter(model);
                    await _unitOfWork.SaveChangesAsync();
                    if (data > 0)
                    {
                        result.State = EnumStatus.Success;
        ...
        [HttpPost("getCalendarEventModelITI")]
        public async Task<ApiResult<DataTable>> getCalendarEventModelITI([FromBody] CalendarEventModel request)
        {
            ActionName = "getCalendarEventModel()";
            return await Task.Run(async () =>
            {
        ...
        [HttpPost("GetAssignedLCStream")]
        public async Task<ApiResult<DataTable>> GetAssignedLCStream([FromBody] PostAttendanceTimeTable request)
        {
            ActionName = "GetReAttendanceTimeTable()";
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    result.Data = await _unitOfWork.StudentRepository.GetAssignedLCStream(request);
                    if (result.Data.Rows.Count > 0)
                    {
                        result.State = EnumStatus.Success;
                        result.Message = Constants.MSG_DATA_LOAD_SUCCESS;
