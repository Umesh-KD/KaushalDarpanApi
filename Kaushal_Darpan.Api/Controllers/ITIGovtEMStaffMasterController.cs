...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class ITIGovtEMStaffMasterController : BaseController
    {
        ...
        [HttpPost("OfficeVacancyListPlanning")]
        public async Task<ApiResult<DataTable>> OfficeVacancyListPlanning(ITIOfficeVacancyModel model)
        {
            ActionName = "OfficeVacancyList(OfficeVacancyModel model)";
            var result = new ApiResult<DataTable>();
            try
            {
                ...
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIGovtEMStaffMasterRepository.OfficeVacancyListPlanning(model);
        ...
        [HttpPost("ITI_EM_DropdownGetData")]
        public async Task<ApiResult<DataTable>> ITI_EM_DropdownGetData(ITI_EM_DroupdownDataModel model)
        {
            ActionName = "ITI_EM_DropdownGetData(ITI_EM_DroupdownDataModel model)";
            var result = new ApiResult<DataTable>();
            try
            {

                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIGovtEMStaffMasterRepository.ITI_EM_DropdownGetData(model);
        ...
        [HttpPost("ITI_OfficeVacancyReport")]
        public async Task<ApiResult<DataTable>> ITI_OfficeVacancyReport(ITIOfficeVacancyModel model)
        {
            ActionName = "OfficeVacancyList(OfficeVacancyModel model)";
            var result = new ApiResult<DataTable>();
            try
            {
                ...
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIGovtEMStaffMasterRepository.ITI_OfficeVacancyReport(model);
        ...
        [HttpPost("GetEmployeeServiceDetails_ITI_EM")]
        public async Task<ApiResult<DataTable>> GetEmployeeServiceDetails_ITI_EM([FromBody] ITI_Govt_EM_UserRequestHistoryListSearchDataModel request)
        {
            ActionName = "GetEmployeeServiceDetails_ITI_EM([FromBody] ITI_Govt_EM_UserRequestHistoryListSearchDataModel request)";
            var result = new ApiResult<DataTable>();
            try
            {
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIGovtEMStaffMasterRepository.GetEmployeeServiceDetails_ITI_EM(request);
...
<table class='footer-sign' style='font-size:15px';margin-top:40px;>
   ...
   <div class='footer'>
    This order is system-generated and does not require an e-signature!
        ...
        [HttpPost("GetServiceDetails")]
        public async Task<ApiResult<DataTable>> GetServiceDetails([FromBody] ServiceRequestModel body)
        {
            ...
            try
            {
                ...
                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIGovtEMStaffMasterRepository.GetServiceDetails(body);
        ...
        [HttpPost("GetVacancyReportPostWise")]
        public async Task<ApiResult<DataTable>> GetVacancyReportPostWise(VacancyReportPostWiseDataModel model)
        {
            ActionName = " GetVacancyReportPostWise(VacancyReportPostWiseDataModel model)";
            var result = new ApiResult<DataTable>();
            try
            {

                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIGovtEMStaffMasterRepository.GetVacancyReportPostWise(model);
        ...
        [HttpPost("GetITIEstablishmentReportData")]
        public async Task<ApiResult<DataTable>> GetITIEstablishmentReportData([FromBody] ITI_Govt_EM_ZonalOFFICERSSearchDataModel body)
        {

            ActionName = "GetITIEstablishmentReportData([FromBody] ITI_Govt_EM_ZonalOFFICERSSearchDataModel body)";
            var result = new ApiResult<DataTable>();
            try
            {

                // Pass the entire model to the repository
                result.Data = await _unitOfWork.ITIGovtEMStaffMasterRepository.GetITIEstablishmentReportData(body);
