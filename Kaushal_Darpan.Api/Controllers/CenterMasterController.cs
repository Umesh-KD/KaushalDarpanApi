...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class CenterMasterController : BaseController
    {
        ...
        public CenterMasterController(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
        ...
        public async Task<ApiResult<DataTable>> GetAllData()
        {
            ...
            try
            {
                result.Data = await _unitOfWork.CenterMasterRepository.GetAllData();
        ...
        [HttpPost("SaveData")]
        public async Task<ApiResult<bool>> SaveData([FromBody] CenterMasterModel request)
        {
            ...
            return await Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    result.Data = await _unitOfWork.CenterMasterRepository.SaveData(request);
