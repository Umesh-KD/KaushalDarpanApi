...
namespace Kaushal_Darpan.Api.Controllers
{
    ...
    public class AdminDashboardIssueTrackerController : BaseController
    {
      //  public override string PageName => "AdminDashboardIssueTrackerController";
        public override string PageName => "IssuetrackerDashboard";
        public override string ActionName { get; set; }

        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public AdminDashboardIssueTrackerController(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
            _unitOfWork = unitOfWork;
        }
        [HttpPost("GetAdminDashData")]
        public async Task<ApiResult<DataTable>> GetAdminDashData([FromBody] AdminDashboardIssueTrackerSearchModel model)

        {
            ...
            try
            {
                result.Data = await _unitOfWork.AdminDashboardIssueTrackerRepository.GetAdminDashData(model);
